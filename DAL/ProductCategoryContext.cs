 ...
 */
        private ProductCategoryContext _prodContext;
       ...
       protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<DimProductCategory>(
                    eb =>
                    {
                       // eb.HasKey("ProductCategoryKey");   // also  
                        eb.ToTable("DimProductCategory");
                       // eb.Property(v => v.CurrencyKey).HasColumnName("CurrencyKey");  //.HasColumnType("int(11)");
                     //  eb.Property(v => v.ProductCategoryKey).HasColumnName("ProductCategoryKey");
                   ...
                   // .HasDefaultValueSql("'1'");
                    ...
                    modelBuilder.Entity<DimProductCategory>()
                                .HasMany<DimProductSubcategory>(c => c.DimProductSubcategory)
                                .WithOne(e => e.DimProductCategory)
                                .IsRequired()
                               // .Ignore(x => x.DimProductSubcategory)
                                .OnDelete(DeleteBehavior.ClientSetNull);  //.Cascade); //SetNull);
// The DELETE statement conflicted with the REFERENCE constraint "FK_DimProductSubcategory_DimProductCategory". 
// The conflict occurred in database "AdventureWorksDW2012", table "dbo.DimProductSubcategory", column 'ProductCategoryKey'.
/***
WHERE [ProductCategoryKey] = @p0;
      SELECT @@ROWCOUNT;
fail: Microsoft.EntityFrameworkCore.Update[10000]
      An exception occurred in the database while saving changes for context type 'DotNetCoreAPI.DAL.ProductCategoryContext'.
**/
 ...
 protected override void OnModelCreating(DbModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Student>().HasKey<int>(s => new { s.StudentKey, s.StudentName }); 
                        ...
                        modelBuilder.Entity<DimProductSubcategory>().HasMany();Delete
...
protected override void OnModelCreating(ModelBuilder builder)
{
    builder.Entity<User>()
        ...
        **/
        ...
        public async Task<DimProductCategory>  Add(DimProductCategory DimProductCategory){
            var result = await _prodContext.DimProductCategory.AddAsync(DimProductCategory);
